<header class="p-3 mb-4 text-bg-light">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
                <span class="fs-4 text-bg-light text-green">Organ Call</span>
...
<?php /**PATH C:\laragon\www\organcall\src\Views/layout/header.blade.php ENDPATH**/ ?>